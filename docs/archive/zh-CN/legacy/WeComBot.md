...
A **Go-based** WeCom (Enterprise WeChat/企业微信) Robot implementation for [BotMatrix](../README.md).

## ✨ Features

*   **Enterprise Integration**: Supports WeCom Enterprise Internal Apps.
...
WeComBot fully supports the **Burn After Reading** feature.
...
cd WeComBot
go mod tidy
go build -o WeComBot.exe main.go
./WeComBot.exe
```
