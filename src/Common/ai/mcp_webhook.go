...
func NewGenericWebhookMCPHost(endpoint, apiKey string, tools []types.MCPTool) *GenericWebhookMCPHost {
...
func (h *GenericWebhookMCPHost) ListTools(ctx context.Context, serverID string) ([]types.MCPTool, error) {
	return h.Tools, nil
}

func (h *GenericWebhookMCPHost) ListResources(ctx context.Context, serverID string) ([]types.MCPResource, error) {
	return nil, nil
}

func (h *GenericWebhookMCPHost) ListPrompts(ctx context.Context, serverID string) ([]types.MCPPrompt, error) {
	return nil, nil
}
