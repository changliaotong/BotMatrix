...
<template>
  <div class="digital-employee-dashboard min-h-screen bg-[var(--bg-body)] text-[var(--text-main)] font-sans relative overflow-hidden selection:bg-[var(--matrix-color)] selection:text-white industrial pt-8">
