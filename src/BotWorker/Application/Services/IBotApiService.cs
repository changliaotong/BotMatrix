...
{
    /// <summary>
    /// 机器人协�?API 服务：负责与 OneBot 等底层协议交�?    /// </summary>
    ...
    {
        // 这里的实现将包含实际�?HTTP/WebSocket 发送逻辑
        // 目前为了重构，我们可以先通过 BotMessage 的实例方法代理，后续再彻底重�?        public async Task KickMemberAsync(long selfId, long groupId, long userId, bool rejectAddRequest = false)
        {
            // 实际调用底层协议
        }
