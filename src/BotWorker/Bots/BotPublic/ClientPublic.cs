...
namespace BotWorker.Bots.Public
{
    public class ClientPublic : MetaData<ClientPublic>
    {
        ...
        public const string regexRec = @"^推荐人(qq|q|号码)*[ :：　+＋十]*(?<recQQ>[1-9]\d{4,10})?";
        ...
        // 通过机器人KEY与客户KEY获得对应的QQ号码，没有则添加之
        ...
        public static string GetBindToken(BotMessage bm, string tokenType, string bindToken)
        {
            ...
            {
                //QQ私聊得到TOKEN，发到微信群或微信公众号领取分（微信机器人的在PYTHON代码实现，公众号的在此)
                return "功能尚未实现，请稍候";
            }
            return res;
        }
