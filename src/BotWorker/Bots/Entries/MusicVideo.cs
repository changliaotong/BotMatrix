...
namespace BotWorker.Bots.Entries
{
    public class MusicVideo : MetaData<MusicVideo>
    {
        ...
        public static BotWorker.Models.AppMessage GetAppMessage(string mvVid)
        {
            return new BotWorker.Models.AppMessage
            {
        ...
        // 收到MV分享消息时添加到MV库
        public static int HandleApp(long botUin, long groupId, long userId, BotWorker.Models.AppMessage message)
        {
