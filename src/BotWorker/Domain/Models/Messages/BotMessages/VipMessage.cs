...
public partial class BotMessage : MetaData<BotMessage>
{
        ...
        public async Task<string> GetChangeGroupAsync()
        {
            ...
            int i = await GroupVip.ChangeGroupAsync(GroupId, new_groupId, UserId);
            if (i == -1)
                return RetryMsg;
        ...
        public async Task<string> GetChangeOwnerAsync()
        {
            ...
            var (resCode, newValue) = await AddCreditAsync(-12000, "换主人扣分");
            if (resCode == -1)
                return RetryMsg;
            ...
            int i = await GroupInfo.SetValueAsync("RobotOwner", newUserId, GroupId);
            if (i == -1)
                return RetryMsg;
        ...
        public string GetBuyRobot() => GetBuyRobotAsync().GetAwaiter().GetResult();
        ...
        // 购买 买入命令分类 买分 买道具 购买一切 根据不同参数调用不同的函数
        public string GetBuyRes() => GetBuyResAsync().GetAwaiter().GetResult();
        ...
        public string GetGoodsCredit() => GetGoodsCreditAsync().GetAwaiter().GetResult();
        ...
        public string GetUpgrade() => GetUpgradeAsync().GetAwaiter().GetResult();
