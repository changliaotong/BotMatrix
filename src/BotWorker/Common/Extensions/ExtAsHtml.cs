    ...
    public static class ExtAsHtml
    {
        ...
        public static string HighLightHtml(this string? text, string keyword)
        {
            ...
            if (keyword.Contains('%'))
            {
                ...
                {
                    res = res.HighLightHtml(key); // 递归处理每个关键�?
                }
                return res;
            }
