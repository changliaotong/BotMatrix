...
namespace BotWorker.Common.Exts
{
    public static class ExtT
    {
        ...
        /// <returns>返回 true 或 false，概率各为 50%</returns>
        ...
        /// <exception cref="ArgumentException">当 size 小于等于 0 时抛出</exception>
        ...
        /// </summary>
        /// <typeparam name="T">集合元素类型</typeparam>
        /// <param name="source">元素枚举器</param>
        /// <param name="size">每批的大小</param>
        ...
        /// <returns>返回原始对象本身，支持链式调用</returns>
        ...
        /// 否则返回原值。
        /// </summary>
        /// <typeparam name="T">实现了 IComparable&lt;T&gt; 的类型</typeparam>
        /// <param name="value">要限制的值</param>
        /// <param name="min">允许的最小值</param>
        /// <param name="max">允许的最大值</param>
        /// <returns>限制后的值，保证在[min, max]范围内</returns>
        ...
        /// <summary>
        /// Fisher–Yates 洗牌算法，返回数组，性能更好，避免 CA1859 警告。
        /// </summary>
